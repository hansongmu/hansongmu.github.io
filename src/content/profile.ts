...
export const profile: Profile = {
  ...
  paragraphs: [
    ...
    '여러 부서와 소통하며 업무 흐름과 실사용 환경을 가까이에서 접한 덕분에, 기능 자체보다 사용자 입장에서 자연스럽게 쓰이는 시스템을 고민하게 됐습니다. AI 플랫폼에서는 프론트엔드뿐 아니라 SSE 스트리밍 백엔드, FastAPI 기반 RAG 서버, LangGraph 워크플로우, 벡터 DB와 임베딩 파이프라인까지 직접 구축했고, 그 경험과 시행착오를 사내 ZEUS AI DAY에서 전사 임직원에게 발표하며 공유하기도 했습니다.',
    'IT 운영부터 업무 시스템, AI 플랫폼까지 쌓아온 경험을 바탕으로, 인접 직군과 자연스럽게 호흡을 맞추고 서로 다른 관점의 의견을 보태며 팀에 기여하고 싶습니다.',
  ],
  links: [
